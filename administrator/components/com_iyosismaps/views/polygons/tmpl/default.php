...
<form action="<?php echo JRoute::_('index.php?option=com_iyosismaps&view=polygons'); ?>" method="post" name="adminForm" id="adminForm">
<div id="editcell">
	...
	<?php foreach($this->items as $i => $item): ?>
		<tr class="row<?php echo $i % 2; ?>">
			...
			<td>
				<a href="<?php echo JRoute::_('index.php?option=com_iyosismaps&task=polygon.edit&id=' . $item->id); ?>">
					<?php echo $item->title; ?>
				</a>
			</td>
			<td class="center">
				<?php echo JHtml::_('jgrid.published', $item->published, $i, 'polygons.'); ?>
			</td>
			<td class="center">
