...
<form action="<?php echo JRoute::_('index.php?option=com_iyosismaps&view=polygon&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="polygon-form" class="form-validate">
	<div class="width-100">
		<fieldset class="adminform">
		<?php
		echo $pane->startPane( 'pane' );
		echo $pane->startPanel( JText::_( 'COM_IYOSISMAPS_POLYGON' ), 'panel1' );
		?>
		<div>
			...
			<li><?php echo $this->form->getLabel('fillcolor'); ?>
			<?php echo $this->form->getInput('fillcolor'); ?></li>

			<li><?php echo $this->form->getLabel('fillopacity'); ?>
			<?php echo $this->form->getInput('fillopacity'); ?></li>
	...
	<div>
		<input type="hidden" name="task" value="polygon.edit" />
