...
//			$link = 'index.php?option=com_falang&amp;task=manage.overview';
...
//			$link = 'index.php?option=com_falang&amp;task=statistics.overview';
...
//			$link = 'index.php?option=com_falang&amp;task=plugin.show';
