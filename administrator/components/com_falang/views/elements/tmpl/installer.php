...
<form action="index2.php" method="post" name="adminForm">
    ...
    <tr>
      ...
      <th class="title" width="35%" align="left"><?php echo JText::_('COM_FALANG_ELEMENT_TITLE_NAME');?></th>
      <th width="15%" align="left"><?php echo JText::_('COM_FALANG_ELEMENT_TITLE_AUTHOR');?></th>
      <th width="15%" nowrap="nowrap" align="left"><?php echo JText::_('COM_FALANG_ELEMENT_TITLE_VERSION');?></th>
      <th nowrap="nowrap" align="left"><?php echo JText::_('COM_FALANG_ELEMENT_TITLE_DESCRIPTION');?></th>
    </tr>
	<?php
	$k=0;
	$i=0;
