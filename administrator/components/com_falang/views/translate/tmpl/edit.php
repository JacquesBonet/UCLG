...
$document->addScript('administrator/components/com_falang/assets/js/mambojavascript.js');
		...
		<table width="90%" border="0" cellpadding="2" cellspacing="2" class="adminform">
		    ...
		    <tr class="<?php echo "row$k"; ?>">
		      ...
		      <table class='translateparams'>
			      <tr>
				      <td valign="top" style="text-align:center!important"><?php echo JText::_('COM_FALANG_ORIGINAL');?></td>
				      <td valign="top" style="text-align:center!important"><?php echo JText::_('COM_FALANG_TRANSLATION');?></td>
