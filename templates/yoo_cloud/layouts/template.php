...
<body id="page" class="page <?php echo $this['config']->get('body_classes'); ?>" data-config='<?php echo $this['config']->get('body_config','{}'); ?>'>
	...
	<div id="page-bg">
		...
		<div id="page-bg2">
			...
			<div id="block-header" class="wrapper grid-block">
				...
				<header id="header">
					...
					<div id="menubar" class="grid-block">
						...
						<?php if ($this['modules']->count('langUCLG')) : ?>
							<div id="langUCLG"><?php echo $this['modules']->render('langUCLG'); ?></div>
						<?php endif; ?>
						<?php  if ($this['modules']->count('menu')) : ?>
							<nav id="menu"><?php echo $this['modules']->render('menu'); ?>
