...
<?php if (count($images)) : ?>
<div id="gallery-<?php echo $widget_id; ?>" class="wk-slideshow wk-gallery-default">
	<div>
		<ul class="slides">
...
<script type="text/javascript">
	...
	jQuery(function($){
		...
		$.widgetkit.lazyloaders.slideshow($("#gallery-<?php echo $widget_id; ?>"), <?php echo json_encode($settings); ?>);
	});
