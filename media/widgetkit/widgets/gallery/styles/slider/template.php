...
<?php if (count($images)) : ?>
<div class="wk-gallery-slider" id="gallery-slider-<?php echo $widget_id; ?>">
<ul class="slides">
...
<script type="text/javascript">
	...
	jQuery(function($){
		...
		$.widgetkit.lazyloaders["gallery-slider"]($("#gallery-slider-<?php echo $widget_id; ?>"), <?php echo json_encode($settings); ?>);
	});
